    ...
    <div class="container">
        <div class="center">
            ...
            <div class="pagination">
                <a href="?page=1&sort=<?= $sort . "&search=" . $search . '&searchA=' . $searchA ?>" class="pagination-link <? if ($page == 1)
                              echo 'page-active' ?>">1</a>
                    <a href="?page=2&sort=<?= $sort . "&search=" . $search . '&searchA=' . $searchA ?>" class="pagination-link <? if ($page == 2)
                                  echo 'page-active' ?>">2</a>
                    <a href="?page=3&sort=<?= $sort . "&search=" . $search . '&searchA=' . $searchA ?>" class="pagination-link <? if ($page == 3)
                                  echo 'page-active' ?>">3</a>
                    <a href="?page=4&sort=<?= $sort . "&search=" . $search . '&searchA=' . $searchA ?>" class="pagination-link <? if ($page == 4)
                                  echo 'page-active' ?>">4</a>
                    <a href="?page=5&sort=<?= $sort . "&search=" . $search . '&searchA=' . $searchA ?>" class="pagination-link <? if ($page == 5)
